...
ROM USB_DEVICE_DESCRIPTOR device_dsc=
{
    ...
    0xC02E,                 // Product ID: AS3993 Demoboard with PIC
...
ROM struct{BYTE bLength;BYTE bDscType;WORD string[6];}sd001={sizeof(sd001),USB_DESCRIPTOR_STRING,{'a','m','s',' ','A','G'}};

//Product string descriptor
ROM struct{BYTE bLength;BYTE bDscType;WORD string[27];}sd002={
sizeof(sd002),USB_DESCRIPTOR_STRING,
{'A','S','3','9','9','3',' ','R','e','a','d','e','r',
        ' ','D','e','m','o','b','o','a','r','d'
}};
